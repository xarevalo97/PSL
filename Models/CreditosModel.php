...
class CreditosModel extends Mysql
{
	...
	public function insertCredito(string $identificacion, string $nombre, string $apellido, int $telefono, string $email, string $password, int $tipoid, string $nit, string $nomFiscal, string $dirFiscal){
	...
	public function selectCredito(int $idpersona){
	...
	public function updateCredito(int $idUsuario, string $identificacion, string $nombre, string $apellido, int $telefono, string $email, string $password, string $nit, string $nomFiscal, string $dirFiscal){
	...
	public function deleteCredito(int $intIdpersona)
	{
