...
class TarjetasModel extends Mysql
{
	...
	public function insertTarjeta(string $identificacion, string $nombre, string $apellido, int $telefono, string $email, string $password, int $tipoid, string $nit, string $nomFiscal, string $dirFiscal){
	...
	public function selectTarjeta(int $idpersona){
	...
	public function updateTarjeta(int $idUsuario, string $identificacion, string $nombre, string $apellido, int $telefono, string $email, string $password, string $nit, string $nomFiscal, string $dirFiscal){
	...
	public function deleteTarjeta(int $intIdpersona)
	{
