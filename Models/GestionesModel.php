<?php 
class GestionesModel extends Mysql
{
	...
	public function insertGestion(string $identificacion, string $nombre, string $apellido, int $telefono, string $email, string $password, int $tipoid, string $nit, string $nomFiscal, string $dirFiscal){
	...
	public function selectGestiones()
	{
	...
	public function selectGestion(int $idpersona){
	...
	public function updateGestion(int $idUsuario, string $identificacion, string $nombre, string $apellido, int $telefono, string $email, string $password, string $nit, string $nomFiscal, string $dirFiscal){
	...
	public function deleteGestion(int $intIdpersona)
	{
